      ...
      <section className="bg-navy paper-texture-dark py-24 sm:py-32">
        <div className="container mx-auto px-4 sm:px-6 max-w-3xl text-center">
          ...
          <div className="flex justify-center">
            <Button asChild size="lg" className="btn-shimmer bg-gold text-navy-deep hover:bg-gold-hover font-display font-bold text-base px-10 py-6 rounded-full shadow-lg shadow-gold/20 transition-all hover:shadow-xl hover:shadow-gold/30 hover:scale-105">
